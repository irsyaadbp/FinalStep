...
// Simple regex-based HTML sanitizer for React Native environments where DOM-based sanitizers like DOMPurify fail.
export const sanitizeHtml = (html: string) => {
  if (!html) return '';
  // Basic tag stripping as a fallback for mobile
